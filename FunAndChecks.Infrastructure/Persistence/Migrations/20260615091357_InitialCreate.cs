        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Letter = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowSelfJoin = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    SubjectId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueEvents_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminGroupAccesses", x => new { x.AdminId, x.GroupId });
                    table.ForeignKey(
                        name: "FK_AdminGroupAccesses_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminGroupAccesses_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminSubjectAccesses", x => new { x.AdminId, x.SubjectId });
                    table.ForeignKey(
                        name: "FK_AdminSubjectAccesses_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminSubjectAccesses_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentGrades_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    CurrentAdminId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QueueEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QueueEntries_Admins_CurrentAdminId",
                        column: x => x.CurrentAdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_QueueEntries_QueueEvents_QueueEventId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminId = table.Column<Guid>(type: "uuid", nullable: false),
                    QueueEventId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Submissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Submissions_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Submissions_QueueEvents_QueueEventId",
                        column: x => x.QueueEventId,
                        principalTable: "QueueEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminGroupAccesses_GroupId",
                table: "AdminGroupAccesses",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_AdminSubjectAccesses_SubjectId",
                table: "AdminSubjectAccesses",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueEntries_CurrentAdminId",
                table: "QueueEntries",
                column: "CurrentAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueEntries_QueueEventId_StudentId",
                table: "QueueEntries",
                columns: new[] { "QueueEventId", "StudentId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_QueueEventId",
                table: "Submissions",
                column: "QueueEventId");

            migrationBuilder.CreateIndex(
                name: "IX_Submissions_StudentId_TaskId",
                table: "Submissions",
